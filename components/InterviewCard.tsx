...
const InterviewCard = async ({
  ...
  return (
    <div
      className="group relative w-full min-h-96 bg-white/10 backdrop-blur-lg border border-white/10 rounded-2xl p-6 shadow-lg hover:border-lime-400 
    ...
    >
      ...
      <div className="relative mb-6 flex justify-center">
        <div className="w-24 h-24 bg-gray-800 rounded-2xl flex items-center justify-center overflow-hidden border-2  shadow-md">
          <Image
      ...
      {/* Interview Role */}
      <h3 className="text-xl font-bold mb-2 text-lime-400 text-center">
        {role} Interview
      </h3>
